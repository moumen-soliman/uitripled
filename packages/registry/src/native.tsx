...
import { BottomModal } from "@uitripled/ui/components/modals/bottom-modal";
...
import {
  ...
  NativeBadgeNeutral,
  NativeBadgeOutline,
} from "@uitripled/ui/components/native/carbon/demo/native-badge-demo";
import {
  NativeCounterUpCurrency,
  NativeCounterUpDefault,
  NativeCounterUpPercentage,
} from "@uitripled/ui/components/native/carbon/demo/native-counter-up-demo";
import {
...
} from "@uitripled/ui/components/native/carbon/demo/native-follow-cursor-demo";
import { NativeBadge } from "@uitripled/ui/components/native/carbon/native-badge-carbon";
import { NativeCounterUp } from "@uitripled/ui/components/native/carbon/native-counter-up-carbon";
import { NativeFlipText } from "@uitripled/ui/components/native/carbon/native-flip-text-carbon";
import { NativeFollowCursor } from "@uitripled/ui/components/native/carbon/native-follow-cursor-carbon";
import { NativeMagnetic } from "@uitripled/ui/components/native/carbon/native-magnetic-carbon";
import { NativeTypewriter } from "@uitripled/ui/components/native/carbon/native-typewriter-carbon";
import {
...
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-avatar-expand-demo";
import {
...
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-avatar-with-name-demo";
import {
  NativeButtonDefault,
  ...
  NativeButtonLoading,
  NativeButtonOutline,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-button-demo";
import {
  ...
  NativeDeleteNoIcon,
  NativeDeleteSmall,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-delete-demo";
import { NativeDialogDemo } from "@uitripled/ui/components/native/shadcn-ui/demo/native-dialog-demo";
import {
  NativeFlipTextColored,
  NativeFlipTextDefault,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-flip-text-demo";
import {
...
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-hover-card-demo";
import {
...
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-image-checkbox-demo";
import {
...
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-liquid-button-demo";
import {
  NativeMagneticDefault,
  NativeMagneticLink,
  NativeMagneticStrong,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-magnetic-demo";
import {
  NativeMorphingButtonCustomIcon,
  NativeMorphingButtonDefault,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-morphing-button-demo";
import {
  NativeNotificationBellCustomIcon,
  NativeNotificationBellDefault,
  NativeNotificationBellEmpty,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-notification-bell-demo";
import {
  ...
  NativeStartNowSmall,
  NativeStartNowSolid,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-start-now-demo";
import { NativeTabsDemo } from "@uitripled/ui/components/native/shadcn-ui/demo/native-tabs-demo";
import {
  NativeTooltipBlur,
  NativeTooltipScale,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-tooltip-demo";
import {
  NativeTypewriterDefault,
  NativeTypewriterLoop,
  NativeTypewriterMultiline,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-typewriter-demo";
import {
  SocialButtonsGlow,
  SocialButtonsScale,
  SocialButtonsShine,
  SocialButtonsSlide,
} from "@uitripled/ui/components/native/shadcn-ui/demo/social-login-demo";
import { NativeAvatarExpand } from "@uitripled/ui/components/native/shadcn-ui/native-avatar-expand-shadcnui";
import { NativeAvatarWithName } from "@uitripled/ui/components/native/shadcn-ui/native-avatar-with-name-shadcnui";
import { NativeButton } from "@uitripled/ui/components/native/shadcn-ui/native-button-shadcnui";
import { NativeDelete } from "@uitripled/ui/components/native/shadcn-ui/native-delete-shadcnui";
import { NativeDialog } from "@uitripled/ui/components/native/shadcn-ui/native-dialog-shadcnui";
import { NativeHoverCard } from "@uitripled/ui/components/native/shadcn-ui/native-hover-card-shadcnui";
import { NativeImageCheckbox } from "@uitripled/ui/components/native/shadcn-ui/native-image-checkbox-shadcnui";
import { NativeLiquidButton } from "@uitripled/ui/components/native/shadcn-ui/native-liquid-button-shadcnui";
import { NativeMorphingButton } from "@uitripled/ui/components/native/shadcn-ui/native-morphing-button-shadcnui";
import { NativeNotificationBell } from "@uitripled/ui/components/native/shadcn-ui/native-notification-bell-shadcnui";
import { NativeStartNow } from "@uitripled/ui/components/native/shadcn-ui/native-start-now-shadcnui";
import { NativeTabs } from "@uitripled/ui/components/native/shadcn-ui/native-tabs-shadcnui";
import { NativeTooltip } from "@uitripled/ui/components/native/shadcn-ui/native-tooltip-shadcnui";
import { SocialLoginButton } from "@uitripled/ui/components/native/shadcn-ui/social-login-button-shadcnui";

import { NativeNestedList } from "@uitripled/ui/components/native/shadcn-ui/native-nested-list-shadcnui";
import { NativeNestedListDemo } from "@uitripled/ui/components/native/shadcn-ui/demo/native-nested-list-demo";
import { NativeNestedListBaseUI } from "@uitripled/ui/components/native/base-ui/native-nested-list-baseui";
import { NativeProfileNotch } from "@uitripled/ui/components/native/shadcn-ui/native-profile-notch-shadcnui";
import {
  NativeProfileNotchOverlay,
  NativeProfileNotchDefault,
} from "@uitripled/ui/components/native/shadcn-ui/demo/native-profile-notch-demo";
import { NativeProfileNotch as NativeProfileNotchBaseUI } from "@uitripled/ui/components/native/base-ui/native-profile-notch-baseui";
...
/>`,
  ...
  <span>user interfaces.</span>
    ...
    codePath: "@uitripled/ui/components/native/carbon/native-flip-text-carbon.tsx", // Main component source
    duration: "2000ms",
    easing: "spring",
    display: true,
    availableIn: ["shadcnui", "carbon", "baseui"],
...
<NativeBadge variant="animated" icon={<Zap className="h-3 w-3 text-primary" />}>Fast</NativeBadge>`,
  ...
  },
  {
    ...
    codePath:
      "@uitripled/ui/components/native/shadcn-ui/native-notification-bell-shadcnui.tsx",
    duration: "600ms",
    easing: "easeInOut",
    display: true,
    availableIn: ["shadcnui", "baseui"],
...
/>`,
    ...
    codePath:
      "@uitripled/ui/components/native/shadcn-ui/native-morphing-button-shadcnui.tsx",
    duration: "300ms",
    easing: "spring",
    display: true,
    availableIn: ["shadcnui", "baseui"],
...
/>`,
    ...
    codePath:
      "@uitripled/ui/components/native/shadcn-ui/native-avatar-with-name-shadcnui.tsx",
    duration: "300ms",
    easing: "spring",
    display: true,
    availableIn: ["shadcnui", "baseui"],
