...
description: A click-driven action picker whose multi-level submenu opens beside the row and drills in place with an animated breadcrumb at a fixed width. (Base UI)
component: true
---
...
import { NativeActionDropdown } from "@uitripled/react-baseui/src/components/native/native-action-dropdown-baseui.tsx"
...
```bash
npx shadcn@latest add @uitripled/native-action-dropdown-baseui
```
...
The `Native Action Dropdown` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="native-action-dropdown-baseui" title="@uitripled/react-baseui/src/components/native/native-action-dropdown-baseui.tsx" />
