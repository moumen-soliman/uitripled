...
import { NativeMarquee } from "@uitripled/react-shadcn/src/components/native/native-marquee-shadcnui.tsx"
...
```bash
npx shadcn@latest add @uitripled/native-marquee-shadcnui
```
...
<ComponentSource name="native-marquee-shadcnui" title="@uitripled/react-shadcn/src/components/native/native-marquee-shadcnui.tsx" />
