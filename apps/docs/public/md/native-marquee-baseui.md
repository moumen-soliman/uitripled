...
import { NativeMarquee } from "@uitripled/react-baseui/src/components/native/native-marquee-baseui.tsx"
...
```bash
npx shadcn@latest add @uitripled/native-marquee-baseui
```
...
The `Native Marquee` component uses the following components. Make sure you have them installed in your project.

- button

<Step>Copy and paste the following code into your project.</Step>

<ComponentSource name="native-marquee-baseui" title="@uitripled/react-baseui/src/components/native/native-marquee-baseui.tsx" />
