...
export function TimelineBlockBaseui() {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, amount: 0.3 });
...
0:{"buildId":"bFBIq5AO28jMw9-shWxSc","rsc":["$","$1","c",{"children":[["$","$L2",null,{"code":"$3","variantCodes":{},"baseId":"timeline-block","baseuiCode":"$4","shadcnuiCode":"$5"}],["$L6","$L7","$L8"],"$L9"]}],"loading":null,"isPartial":false}
